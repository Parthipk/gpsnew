...
export default function PrivacyPolicy() {
  return (
    ...
    <div className="privacy-policy">
      ...
      <h1 style={{ color: '#003366', textAlign:'center' }}>Privacy Policy</h1>
      <p>
      ...
      <h2><strong>1. Collection of Personally Identifiable Information and other Information</strong></h2>
      <p>
      ...
      <h2><strong>2. Use of Demographic / Profile Data / Your Information</strong></h2>
      <p>
      ...
      <h2><strong>3. Sharing of personal information</strong></h2>
      <p>
      ...
      <h2><strong>4. Security Precautions</strong></h2>
      <p>
        Our Website has stringent security measures in place to protect the loss, misuse, and alteration of the information under our control. Whenever you change or access your account information, we offer the use of a secure server. Once your information is in our possession we adhere to strict security guidelines, protecting it against unauthorized access.
      </p>

      <h2><strong>5. Choice/Opt-Out</strong></h2>
      <p>
      ...
      <h2><strong>6. Your Consent</strong></h2>
      <p>
